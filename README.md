...
## Built-in
`* + - / < > apply bound car ccc cdr close coerce cons cos dir disp err expt eval flushout infile int is len log macex maptable mod mvfile newstring outfile quit rand read readline rmfile scar scdr sin sqrt sread stderr stdin stdout string sym system t table tan trunc type write writeb`
